...
> Rust 重构版路径：`week1/web-search-agent`

## 这节课要解决什么

把网络搜索建模为 Agent 的感知工具，并练习多轮检索与答案综合。
...
```bash
cargo run -p agent-course-week1-web-search-agent
```

单独测试这一节：

```bash
cargo test -p agent-course-week1-web-search-agent
```
