...
> Rust 重构版路径：`week4/perception-tools`

## 这节课要解决什么

封装搜索、文件、多模态和公共数据源，形成 Agent 感知层。
...
```bash
cargo run -p agent-course-week4-perception-tools
```

单独测试这一节：

```bash
cargo test -p agent-course-week4-perception-tools
```
