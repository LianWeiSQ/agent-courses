const TITLE: &str = r#"生产级 Coding Agent"#;
const SUMMARY: &str = r#"实现 inspect-plan-edit-verify-report 的代码编辑闭环。"#;
const CONCEPTS: &[&str] = &[r#"代码生成"#, r#"文件编辑"#, r#"Shell"#, r#"验证"#];
...
任务：{}",
    ...
    println!(
        "
结论：工具重构的重点不是 API 形状，而是能力、风险和选择策略都显式化。"
    );
}
