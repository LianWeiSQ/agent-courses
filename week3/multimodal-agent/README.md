...
> Rust 重构版路径：`week3/multimodal-agent`

## 这节课要解决什么

比较原生多模态、文本提取和工具化分析三种路线。
...
```bash
cargo run -p agent-course-week3-multimodal-agent
```

单独测试这一节：

```bash
cargo test -p agent-course-week3-multimodal-agent
```
