...
> Rust 重构版路径：`week2/attention_visualization`

## 这节课要解决什么

把 token 序列和注意力关系变成可观察对象，帮助理解模型如何使用上下文。
...
```bash
cargo run -p agent-course-week2-attention-visualization
```

单独测试这一节：

```bash
cargo test -p agent-course-week2-attention-visualization
```
