...
> Rust 重构版路径：`week2/prompt-engineering`

## 这节课要解决什么

用可控实验比较提示结构、语气、工具描述对 Agent 的影响。
...
```bash
cargo run -p agent-course-week2-prompt-engineering
```

单独测试这一节：

```bash
cargo test -p agent-course-week2-prompt-engineering
```
