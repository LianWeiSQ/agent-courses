...
> Rust 重构版路径：`week7/learn-from-observation`

## 这节课要解决什么

从示范轨迹学习动作模式，不依赖显式逐步标注。
...
```bash
cargo run -p agent-course-week7-learn-from-observation
```

单独测试这一节：

```bash
cargo test -p agent-course-week7-learn-from-observation
```
