...
> Rust 重构版路径：`week7/continued-pretraining`

## 这节课要解决什么

在领域语料上继续预训练，让模型吸收目标领域知识。
...
```bash
cargo run -p agent-course-week7-continued-pretraining
```

单独测试这一节：

```bash
cargo test -p agent-course-week7-continued-pretraining
```
